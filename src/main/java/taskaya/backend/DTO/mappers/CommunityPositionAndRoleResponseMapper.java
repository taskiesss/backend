...
import taskaya.backend.DTO.communities.communityMember.responses.CommunityMemberPositionAndRoleDTO;
...
public class CommunityPositionAndRoleResponseMapper {
    public static CommunityMemberPositionAndRoleDTO toDTO(CommunityMember communityMember, Integer sum){
        ...
        CommunityMemberPositionAndRoleDTO memberDTO = CommunityMemberPositionAndRoleDTO.builder()
    ...
    public static List<CommunityMemberPositionAndRoleDTO> toDTOList(List<CommunityMember> communityMembers) {
